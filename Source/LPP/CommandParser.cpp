...
void BBP::Services::Binaries::LPP::setOutputFile(BBP::Services::Binaries::LPP::CompilationContext* compiler, const char* name)
{
	...
	compiler->outFile = (char*)calloc(compiler->outFileLength + 1, sizeof(char));
...
void BBP::Services::Binaries::LPP::setOutputFile(BBP::Services::Binaries::LPP::CompilationContext *compiler, BBP::Services::Binaries::ELF::stringTable *args, unsigned int arg)
{
...
void BBP::Services::Binaries::LPP::setInterp(BBP::Services::Binaries::LPP::CompilationContext *compiler, BBP::Services::Binaries::ELF::stringTable *args, unsigned int arg)
{
	// Check that the file isnt a switch either
	if ((args->strings[arg])[0] == '-')
	{
	...
	// Alloc data to outfile
	compiler->interp = (char *)calloc(compiler->interpLength + 1, sizeof(char));
...
int BBP::Services::Binaries::LPP::ParseArguments(CompilationContext *compiler, Binaries::ELF::stringTable *args, unsigned int argc)
{
	for (unsigned int arg = 0; arg < argc - 1; arg++)
	{
		...
		BBP::Services::Binaries::ELF::addStringToTable(compiler->inputFiles, option);
	}
...
void BBP::Services::Binaries::LPP::destroyCompiler(BBP::Services::Binaries::LPP::CompilationContext *compiler)
{
	...
	ELF::setStringTableSize(compiler->inputFiles, 0);
...
void BBP::Services::Binaries::LPP::DoCompiling(BBP::Services::Binaries::LPP::CompilationContext *compiler, Binaries::ELF::stringTable *args)
{
...
void BBP::Services::Binaries::LPP::DoLinking(BBP::Services::Binaries::LPP::CompilationContext *compiler, Binaries::ELF::stringTable *args)
{
	compiler->proc->doLinking = false;
	...
	for (unsigned int k = 0; k < compiler->inputFiles->stringCount; k++)
	{
		...
		compiler->outFile = (char *)calloc(compiler->inputFiles->lengths[k], sizeof(char));
...
int BBP::Services::Binaries::LPP::Run(Binaries::ELF::stringTable *args)
{
	...
	compiler->inputFiles = BBP::Services::Binaries::ELF::createStringTable();
