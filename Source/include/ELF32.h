#ifndef BBP_LIB_ELF32
#define BBP_LIB_ELF32
...
#define ELF_HEADER_ENTRYSIZE 4
#define ELF_HEADER_PHOFFOFFSET 28
#define ELF_HEADER_PHOFFSIZE 4
#define ELF_HEADER_SHOFFOFFSET 32
#define ELF_HEADER_SHOFFSIZE 4
#define ELF_HEADER_FLAGSOFFSET 36
#define ELF_HEADER_FLAGSSIZE 4
#define ELF_HEADER_EHSIZEOFFSET 40
#define ELF_HEADER_EHSIZESIZE 2
#define ELF_HEADER_PHENTSIZEOFFSET 42
#define ELF_HEADER_PHENTSIZESIZE 2
#define ELF_HEADER_PHNUMOFFSET 44
#define ELF_HEADER_PHNUMSIZE 2
#define ELF_HEADER_SHENTSIZEOFFSET 46
#define ELF_HEADER_SHENTSIZESIZE 2
#define ELF_HEADER_SHNUMOFFSET 48
#define ELF_HEADER_SHNUMSIZE 2
#define ELF_HEADER_SHSTRNDXOFFSET 50
...
#define ELF_SECTION_FLAGSSIZE 4
#define ELF_SECTION_ADDROFFSET 12
#define ELF_SECTION_ADDRSIZE 4
#define ELF_SECTION_OFFSETOFFSET 16
#define ELF_SECTION_OFFSETSIZE 4
#define ELF_SECTION_SIZEOFFSET 20
#define ELF_SECTION_SIZESIZE 4
#define ELF_SECTION_LINKOFFSET 24
#define ELF_SECTION_LINKSIZE 4
#define ELF_SECTION_INFOOFFSET 28
#define ELF_SECTION_INFOSIZE 4
#define ELF_SECTION_ADDRALIGNOFFSET 32
#define ELF_SECTION_ADDRALIGNSIZE 4
#define ELF_SECTION_ENTSIZEOFFSET 36
#define ELF_SECTION_ENTSIZESIZE 4

#define ELF_SYMBOL_ENTRYSIZE 16
...
#define ELF_SYMBOL_SIZESIZE 4
#define ELF_SYMBOL_INFOOFFSET 12
#define ELF_SYMBOL_INFOSIZE 1
#define ELF_SYMBOL_OTHEROFFSET 13
#define ELF_SYMBOL_OTHERSIZE 1
#define ELF_SYMBOL_SHNDXOFFSET 14
	...
	namespace std
	{
		namespace ELF
		{
			...
			typedef struct {
				...
				std::address_t	e_entry; 		///< Entry point address for executables, Constructor address for shared libraries, otherwise 0.
				std::offset_t	e_phoff; 		///< Program Header Offset (Relative to File start)
				std::offset_t	e_shoff; 		///< Section Header Offset (Relative to File start)
			...
			typedef struct {
				...
				std::word		sh_flags = 0; 		///< Flags. 0x1 - Writeable, 0x2 - part of the sections that are loaded into memory, 0x4 - executable.
				std::address_t	sh_addr = 0; 		///< ?
				std::offset_t 	sh_offset = 0; 		///< The offset relative to the beginning of the file where this segment is.
				std::word 		sh_size = 0;  		///< How large this section is in the file
				...
				std::word 		sh_addralign = 0; 		///< ?
				std::word 		sh_entsize = 0; 		///< Size of each entry?
			} SectionHeader;

			enum SectionTypes : std::byte {
				Writeable = 1,
				Allocator = 2,
				Executable = 4
			};
			...
			typedef struct {
				...
				std::word		st_size = 0; 		///< The size of whatever this symbol is (for example the size of 'main')
