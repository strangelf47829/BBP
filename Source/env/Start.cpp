...
int main()
{
	...
	for (BBP::std::index_t idx = 0; idx < BBP::std::fileTable.dataSize; idx++)
		BBP::std::fileTable.data[idx] = BBP::std::FileNode();
	...
	BBP::std::FILE badappleExec(badAppleStack, "/proc/exec/test");
